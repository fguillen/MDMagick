...
function MDM( inputElement ) {
  ...
  this.activateControls = function( controlsElement ){
    console.log( "activateControls", controlsElement );
  ...
  this.activatePreview = function( inputElement, previewElement ) {
    console.log( "activatePreview.inputElement", inputElement );
    console.log( "activatePreview.previewElement", previewElement );
